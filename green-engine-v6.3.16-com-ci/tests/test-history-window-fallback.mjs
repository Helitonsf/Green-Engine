...
try {
  ...
  assert.equal(result.statusCode, 200, "cenário deveria retornar 200");
  ...
  assert.ok(betweenCalls > 0, "deveria ter chamado fixtures/between ao menos uma vez");

  console.log("\n✅ test-history-window-fallback: todos os asserts passaram.");
} catch (error) {
  console.error("");
  console.error("=== ERRO ===");
  console.error(error);
